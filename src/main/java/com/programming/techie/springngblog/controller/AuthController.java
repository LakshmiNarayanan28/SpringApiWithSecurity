...
public class AuthController {
    ...
    @PostMapping("/signup")  //post request
    public ResponseEntity signup(@RequestBody RegisterRequest registerRequest) {  //ResponseEntity is a built in function to Acknowledgement for me
